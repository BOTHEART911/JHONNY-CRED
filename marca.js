/* ============================================================
   marca.js — JHONNY CRED · credencial pública
   ------------------------------------------------------------
   ...
   Se carga ANTES que storage-ns.js y que cred.js, así que no
   puede depender de nada: solo datos.
   ============================================================ */
(function (raiz) {
  'use strict';
  ...
  raiz.MARCA = {
    ...
    /* Esta app no tiene botón de luna: sigue la preferencia del
       sistema. marca-vivo.js lo necesita para no pisar el tema oscuro. */
    OSCURO_POR_SISTEMA: true,


    /* Carpeta web donde viven las imagenes COMPARTIDAS de la campana
       (logo, banner, foto por defecto). Termina en /.
       Se anadio al ecosistema el 30/07/2026 y a ESTE repo el 02/08/2026,
       al restaurarlo. El valor REAL puede llegar en caliente del CORE
       (MARCA_IMG_BASE); esto es el respaldo. Resolver: MV.img('logo.png'). */
